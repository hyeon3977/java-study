...
public class _05_VariableNaming {
    public static void main(String[] args) {
        ...
        String firstName = "정현"; // 이름
        String lastName = "박"; // 성
        String dateOfBirth = "2001-02-12"; // 생년월일
        String residentialAddress = "호텔"; // 체류지
        String purposeOfVisit = "관광"; // 입국목적
        String flightNo = "KE357"; // 항공 편명
        String _flightNo = "KE357"; //밑줄 시작
        String flight_No_2 = "KE357"; // 밑줄과 숫자 포함
        // String -flightNo = "KE357"; 하이픈으로 시작이라 오류
